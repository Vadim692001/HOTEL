...
namespace IdentityHotel.Controllers
{
    public class NumbersController : Controller
    {
        ...
        [Authorize(Roles = "hairline")]
        public ActionResult Create([Bind(Include = "id_Number,Komplektaci_nomera,Kilcist_pipl,Cina,Numer")] Number number)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "hairline")]
        public ActionResult Edit([Bind(Include = "id_Number,Komplektaci_nomera,Kilcist_pipl,Cina,Numer")] Number number)
        {
            if (ModelState.IsValid)
            {
